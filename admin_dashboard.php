    ...
    <div
        ...
        <div class="card" style="display: flex; align-items: center; gap: 20px;">
            ...
            <div>
                ...
                <span style="color: var(--text-muted);">Total Doctors</span>
            </div>
        </div>
        <div class="card" style="display: flex; align-items: center; gap: 20px;">
            <div
        ...
        <div class="card" style="display: flex; align-items: center; gap: 20px;">
            <div
                style="background: rgba(100, 100, 100, 0.1); padding: 16px; border-radius: 50%; color: #333;">
                ...
                <tbody>
                    <?php if ($users_result->num_rows > 0): ?>
                        <?php while ($row = $users_result->fetch_assoc()): ?>
                            ...
                            $badge_style = "";
                            if ($row['role'] == 'doctor')
                                $badge_style = "background: #E0F7FA; color: #00BCD4;";
                            if ($row['role'] == 'patient')
                                $badge_style = "background: #F1F8E9; color: #8BC34A;";
                            if ($row['role'] == 'admin')
                                $badge_style = "background: #FFEBEE; color: #F44336;";
                            ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge"
                                        style="<?php echo $badge_style; ?>"><?php echo ucfirst($row['role']); ?></span>
