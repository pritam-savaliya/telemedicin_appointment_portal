...
$sql = "SELECT appointments.*, users.fullname as patient_name, users.id as patient_id 
        FROM appointments 
...
<div class="container section">
    <div style="max-width: 800px; margin: 0 auto;">
        <div style="margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center;">
            ...
            <a href="doctor_dashboard.php" class="btn btn-outline"><i class="fas fa-arrow-left"></i> Back</a>
        </div>
